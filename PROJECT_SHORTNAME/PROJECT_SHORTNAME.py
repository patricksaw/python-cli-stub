"""This module provides the PROJECT_FULLNAME model-controller."""

from pathlib import Path
from typing import Any, Dict, List, NamedTuple

from PROJECT_SHORTNAME import DB_READ_ERROR, ID_ERROR
from PROJECT_SHORTNAME.database import DatabaseHandler
